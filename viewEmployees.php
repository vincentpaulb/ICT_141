...
<body id="bg">
	...
	<div class="container">
		<div class="row">	
			...
			<br>
			<br>
			<h2 style="font-family: Century; font-weight: bold; text-align: center;">EMPLOYEES</h2>
			<br>
			...
			<table align="center">
				...
				<?php	
					while($row = mysqli_fetch_assoc($result)){
						echo "<tr>";
						echo "<th style='background-color: #e6f7ff; font-size: 15px;'> {$row['emp_ID']} </th>";
						echo "<th style='background-color: #e6f7ff; font-size: 15px;'> {$row['emp_name']} </th>";
						echo "<th style='background-color: #e6f7ff;'><a style='font-size: 15px; text-decoration: none; color: #992600;' href='viewEmployeeInfo.php?id={$row['emp_ID']}'>View</a><td>";
						echo "</tr>";
					}
				?>
