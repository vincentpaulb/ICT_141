	...
	<div class="container">
		<div class="row">	
			...
			<form action="submitLocation.php" method="POST">
				...
				<h4 style="font-family: Century; font-weight: bold;">New Location Name</h4>
				<input type="text" required name="locname"> <br>

				<h4 style="font-family: Century; font-weight: bold;">Complete Address</h4>
				<input type="text" required ame="address"> <br>
